...
#'
#' @format A data frame with 2959 rows and 12 variables:
#' \describe{
#'   \item{State}{name of the state for which numbers are reported.}
#'   \item{Abb}{two letter state abbreviation. }
#'   \item{Year}{year of the reporting.}
...
#' Ames House Price
#'
#' House sales data for residential homes in Ames, Iowa. Data was compiled by Dean De Cock. Extracted from https://www.kaggle.com/c/house-prices-advanced-regression-techniques/overview
#'
...
#'  }
#'  }
#'   \item{OverallCond}{Rates the overall condition of the house. 10 is Very Excellent, while 1 is Very Poor.}
#'   \item{YearBuilt}{Original construction year}
